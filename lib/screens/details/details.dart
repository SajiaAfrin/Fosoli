...
import 'package:fosoli/screens/video/video_screen.dart';
import 'package:fosoli/widget/custom_button.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    for(int i = 0; i < items["data"]['process'].length; i++)
                    Row(
                      children: [
                        Container(
                          width: 8,
